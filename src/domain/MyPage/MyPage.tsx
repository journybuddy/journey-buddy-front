...
export default function MyPage() {
    return (
      <S.DashboardWrap>
        <S.ProfileHeader>
          <S.ProfileImage src="https://mblogthumb-phinf.pstatic.net/MjAyMjEwMDZfMTM3/MDAxNjY1MDQxNzQyNzQ0.QQi5NvTdqIVFT6RKwe0HPLR3ZCwBH4CCVRH6YIo1k30g.wqRq6A61qFmhd1W0kNnwnXHggdRq5HXY-oC2ZDj8isog.JPEG.90_05_28/IMG_1471.JPG?type=w800" alt="Profile" />
          <S.ProfileInfo>
            <S.ProfileName>정다연</S.ProfileName>
            <S.ProfileDetails>wjdekdus62@naver.com</S.ProfileDetails>
            <S.ButtonGroup>
            <S.FollowButton>프로필 수정</S.FollowButton>
            <S.MessageButton>로그아웃</S.MessageButton>
          </S.ButtonGroup>
          </S.ProfileInfo>
        </S.ProfileHeader>
        <S.Stats>
